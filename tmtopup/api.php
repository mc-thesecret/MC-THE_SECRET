...
$_CONFIG['mysql']['dbhost'] = $Cfg["mysql"]["host"];

// Username ที่ใช้เชื่อมต่อ MySQL Server
$_CONFIG['mysql']['dbuser'] = $Cfg["mysql"]["user"];

// Password ที่ใช้เชื่อมต่อ MySQL Server
$_CONFIG['mysql']['dbpw'] = $Cfg["mysql"]["pass"];

// ชื่อฐานข้อมูลที่เราจะเติม Point ให้
$_CONFIG['mysql']['dbname'] = $Cfg["mysql"]["db"];

// ชื่อตารางที่เราจะเติม Point ให้ ตัวอย่าง : member
$_CONFIG['mysql']['tbname'] = 'authme';    // ห้ามเปลี่ยน

// ชื่อ field ที่ใช้อ้าง Username
$_CONFIG['mysql']['field_username'] = 'username';    // ห้ามเปลี่ยน

// ชื่อ field ที่ใช้ในการเก็บ Point จากการเติมเงิน
$_CONFIG['TMN']['point_field_name'] = 'points';    // ห้ามเปลี่ยน
/* MySQL Config | End */
// ------------------------------------------------------------------------------------------------
...
$_CONFIG['TMN'][50]['point'] = $Cfg["tmt"][50];					// เงินในเกม ที่ได้รับเมื่อเติมเงินราคา 50 บาท
$_CONFIG['TMN'][90]['point'] = $Cfg["tmt"][90];					// เงินในเกม ที่ได้รับเมื่อเติมเงินราคา 90 บาท
$_CONFIG['TMN'][150]['point'] = $Cfg["tmt"][150];				// เงินในเกม ที่ได้รับเมื่อเติมเงินราคา 150 บาท
$_CONFIG['TMN'][300]['point'] = $Cfg["tmt"][300];				// เงินในเกม ที่ได้รับเมื่อเติมเงินราคา 300 บาท
$_CONFIG['TMN'][500]['point'] = $Cfg["tmt"][500];				// เงินในเกม ที่ได้รับเมื่อเติมเงินราคา 500 บาท
$_CONFIG['TMN'][1000]['point'] = $Cfg["tmt"][1000];			// เงินในเกม ที่ได้รับเมื่อเติมเงินราคา 1,000 บาท
/* จำนวน Point ที่จะได้รับเมื่อเติมเงินในราคาต่างๆ | End */
// ------------------------------------------------------------------------------------------------


// กำหนด API Passkey
define('API_PASSKEY', $Cfg["tmt"]['Passkey']); //ใส่ Passkey เพื่อเชื่อมต่อกับระบบ Tmtopup
